...
<div>
  ...
  <div class="cont">
    <div class="form sign-in">
      <h2>Olá, <?php echo $_SESSION['Pnome'];?>! Bem vindo.</h2>

    <a href="confirmar_reserva.php"><button type="button" class="submit"> Fazer check-in/check-out</button></a>
    <a href="relatorio_hoteis.php"><button type="button" class="submit"> Relatório do mês </button></a>
    <a href="painel_adm2.php"><button type="button" class="submit"> Opções avançadas </button></a>
